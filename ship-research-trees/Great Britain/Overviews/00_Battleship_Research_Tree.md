...
graph TD
    %% ============================================================
    %% BRANCH 1: MAIN BATTLESHIP LINE (Standard Dreadnought Evolution)
    %% ============================================================
    MAJ[Majestic-class 1895<br/>FIRST FREE STARTER<br/>4x12in guns<br/>9 ships]
    MAJ --> LORD[Lord Nelson-class 1908<br/>SECOND FREE STARTER<br/>Last pre-dreadnought<br/>4x12in + 10x9.2in<br/>2 ships]
    LORD --> DREAD[HMS Dreadnought 1906<br/>REVOLUTIONARY<br/>ALL-BIG-GUN<br/>10x12in guns]
    DREAD --> BELL[Bellerophon-class 1909<br/>Improved Dreadnought<br/>10x12in guns<br/>3 ships]
    BELL --> STVINC[St Vincent-class 1910<br/>50-cal 12in guns<br/>3 ships]
    STVINC --> NEPT[HMS Neptune 1911<br/>First superfiring<br/>10x12in guns]
    NEPT --> COLO[Colossus-class 1911<br/>Better armor<br/>2 ships]
    COLO --> ORION[Orion-class 1912<br/>FIRST 13.5in GUNS<br/>10x13.5in guns<br/>4 ships]
    ORION --> KGV1[King George V 1912<br/>Longer, faster<br/>10x13.5in guns<br/>4 ships]
    KGV1 --> IRON[Iron Duke-class 1914<br/>JUTLAND FLAGSHIP<br/>10x13.5in guns<br/>4 ships]
    IRON --> QE[Queen Elizabeth-class 1915<br/>FIRST FAST BB<br/>8x15in guns, 25 kts<br/>5 ships]
    QE --> REV[Revenge-class 1916<br/>Cheaper QE<br/>8x15in guns, 21 kts<br/>5 ships]
    REV --> NELS[Nelson-class 1927<br/>FIRST 16in GUNS<br/>9x16in all forward<br/>2 ships]
    NELS --> KGV2[King George V 1940<br/>WWII ULTIMATE<br/>10x14in guns<br/>5 ships]

    %% ============================================================
    %% BRANCH 2: BATTLECRUISER LINE (Speed & Firepower)
    %% ============================================================
    DREAD --> INVINC[Invincible-class 1908<br/>FIRST BATTLECRUISER<br/>8x12in guns, 25 kts<br/>3 ships]
    INVINC --> INDEF[Indefatigable-class 1911<br/>Improved Invincible<br/>8x12in guns<br/>3 ships]
    INDEF --> LION[Lion-class BC 1912<br/>8x13.5in guns, 27 kts<br/>2 ships]
    LION --> TIGER[HMS Tiger 1914<br/>Single ship<br/>8x13.5in guns]
    TIGER --> RENOWN[Renown-class 1916<br/>6x15in guns, 32 kts<br/>2 ships]
    RENOWN --> HOOD[HMS Hood 1920<br/>ULTIMATE BC<br/>8x15in guns, 31 kts<br/>42,000 tons]

    %% ============================================================
    %% BRANCH 3: ALTERNATIVE/CANCELLED LINE
    %% ============================================================
    IRON -.-> COUR[Courageous-class 1917<br/>Light BC<br/>4x15in guns<br/>3 ships to CV]
    COUR -.-> G3[G3-class BC 1921<br/>CANCELLED<br/>9x16in guns, 32 kts<br/>4 ordered]
    G3 -.-> N3[N3-class BB 1921<br/>CANCELLED<br/>9x18in GUNS<br/>4 ordered]
    N3 -.-> LION40[Lion-class 1940<br/>CANCELLED<br/>9x16in guns, 30 kts<br/>2 laid down]
    LION40 -.-> VANG[HMS Vanguard 1946<br/>LAST BRITISH BB<br/>8x15in guns, 30 kts<br/>Built post-war]
    ...
    %% First battleship and free starters
    style MAJ fill:#FFD700,stroke:#333,stroke-width:3px,color:#000
    style LORD fill:#FFD700,stroke:#333,stroke-width:2px,color:#000

    %% Revolutionary dreadnought
    style DREAD fill:#f00,stroke:#333,stroke-width:4px,color:#fff

    %% Mass production / successful classes
    style QE fill:#0f0,stroke:#333,stroke-width:3px,color:#000
    style REV fill:#0f0,stroke:#333,stroke-width:2px,color:#000
    style KGV1 fill:#0f0,stroke:#333,stroke-width:2px,color:#000

    %% First super-dreadnought
    style ORION fill:#0ff,stroke:#333,stroke-width:3px,color:#000

    %% First 16" guns
    style NELS fill:#f90,stroke:#333,stroke-width:3px,color:#000

    %% Ultimate battleship
    style KGV2 fill:#00f,stroke:#333,stroke-width:4px,color:#fff

    %% Ultimate battlecruiser
    style HOOD fill:#ff0,stroke:#333,stroke-width:4px,color:#000

    %% Cancelled designs
    style G3 fill:#DC143C,stroke:#333,stroke-width:2px,color:#fff
    style N3 fill:#DC143C,stroke:#333,stroke-width:2px,color:#fff
    style LION40 fill:#DC143C,stroke:#333,stroke-width:2px,color:#fff

    %% Converted/Special
    style COUR fill:#9370DB,stroke:#333,stroke-width:2px,color:#fff
    style VANG fill:#9370DB,stroke:#333,stroke-width:2px,color:#fff
```
