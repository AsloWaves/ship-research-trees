"""
Generate German Naval Turrets (IDs 4000-4999)
...
print(f"Generated {len(turrets)} turrets (IDs 4000-{turret_id-1})")
print()
...
# Save as JSON
output_file = '../../data/german_turrets.json'
...
sql_output = '../../data/german_turrets.sql'
with open(sql_output, 'w', encoding='utf-8') as f:
    f.write(f"-- German Naval Turrets (IDs 4000-{turret_id-1})\n")
