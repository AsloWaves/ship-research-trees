...
graph TD
    %% ============================================================
    %% BRANCH 1: STANDARD BATTLESHIP LINE (Main Progression)
    %% ============================================================
    IND[Indiana BB-1 1895<br/>FIRST US BATTLESHIP<br/>FREE]
    IND --> IA[Iowa BB-4 1897]
    IA --> ILL[Illinois BB-7 1901]
    ILL --> MAINE[Maine BB-10 1902]
    MAINE --> CONN[Connecticut BB-18 1906<br/>Great White Fleet<br/>8 SHIPS]

    %% To Dreadnought Era
    CONN --> SC[South Carolina BB-26 1910<br/>FIRST DREADNOUGHT<br/>8x12in]
    SC --> DEL[Delaware BB-28 1910<br/>10x12in]
    DEL --> WYO[Wyoming BB-32 1912<br/>12x12in]
    WYO --> NY[New York BB-34 1914<br/>FIRST 14-INCH]

    %% Super-Dreadnought Era
    NY --> NEV[Nevada BB-36 1916<br/>ALL-OR-NOTHING ARMOR<br/>Oil-fired]
    NEV --> PENN[Pennsylvania BB-38 1916<br/>12x14in]
    PENN --> NM[New Mexico BB-40 1918<br/>Turbo-electric]
    NM --> TENN[Tennessee BB-43 1920<br/>Clipper bow]
    TENN --> COLO[Colorado BB-45 1923<br/>FIRST 16-INCH<br/>8x16in]

    %% Treaty Gap to Modern Battleships
    COLO --> NC[North Carolina BB-55 1941<br/>FAST BATTLESHIP<br/>28 knots]
    NC --> SD[South Dakota BB-57 1942<br/>Compact armor<br/>4 SHIPS]
    SD --> IOWA[Iowa BB-61 1943<br/>33 KNOTS<br/>ULTIMATE BB<br/>4 built]

    %% ============================================================
    %% BRANCH 2: ALTERNATIVE/EXPERIMENTAL LINE
    %% ============================================================
    %% Alternative pre-dreadnought path
    IND -.-> KEAR[Kearsarge BB-5 1900<br/>Superimposed turrets]
    KEAR -.-> VIRG[Virginia BB-13 1906<br/>5 ships]
    VIRG -.-> CONN

    %% Alternative dreadnought progression
    SC -.-> FLA[Florida BB-30 1911<br/>10x12in]
    FLA -.-> NY

    %% Design studies and cancelled programs
    PENN -.-> TILL[Tillman Maximum 1916<br/>DESIGN STUDY<br/>24x16in OR 15x18in<br/>80,000 tons]

    COLO -.-> LEX[Lexington-class BC 1916<br/>BATTLECRUISER<br/>8x16in, 35 knots<br/>2→CV, 4 cancelled]
    COLO -.-> SD20[South Dakota BB-49 1920<br/>12x16in<br/>6 CANCELLED 1922]

    %% Montana cancelled super-battleship
    SD --> MONT[Montana BB-67 1943<br/>SUPER BATTLESHIP<br/>12x16in<br/>5 CANCELLED]

    %% Alternative path to Iowa via experimental designs
    SD20 -.-> NC
    LEX -.-> NC

    %% ============================================================
    %% BRANCH 3: FAST CAPITAL SHIP LINE (Battlecruiser heritage)
    %% ============================================================
    %% Lexington battlecruiser to carrier conversions
    LEX -.-> LEXCV[Lexington CV-2 1927<br/>BC→CV CONVERSION<br/>8x8in guns retained]
    LEXCV -.-> SARCV[Saratoga CV-3 1927<br/>BC→CV sister]

    %% Alaska large cruisers (battlecruiser type)
    COLO -.-> AK[Alaska CB-1 1944<br/>LARGE CRUISER<br/>9x12in, 33 knots<br/>2 built]
    AK -.-> IOWA
    ...
    %% First battleship
    style IND fill:#f9f,stroke:#333,stroke-width:3px,color:#000

    %% Dreadnought revolution
    style SC fill:#0ff,stroke:#333,stroke-width:3px,color:#000

    %% All-or-nothing armor innovation
    style NEV fill:#ff0,stroke:#333,stroke-width:3px,color:#000

    %% First 16-inch guns
    style COLO fill:#f90,stroke:#333,stroke-width:3px,color:#000

    %% Ultimate battleship
    style IOWA fill:#00f,stroke:#333,stroke-width:4px,color:#fff

    %% Mass production
    style CONN fill:#0f0,stroke:#333,stroke-width:2px,color:#000
    style SD fill:#0f0,stroke:#333,stroke-width:2px,color:#000

    %% Cancelled/Design studies
    style TILL fill:#DC143C,stroke:#333,stroke-width:2px,color:#fff
    style LEX fill:#DC143C,stroke:#333,stroke-width:2px,color:#fff
    style SD20 fill:#DC143C,stroke:#333,stroke-width:2px,color:#fff
    style MONT fill:#DC143C,stroke:#333,stroke-width:2px,color:#fff

    %% Converted carriers
    style LEXCV fill:#9370DB,stroke:#333,stroke-width:2px,color:#fff
    style SARCV fill:#9370DB,stroke:#333,stroke-width:2px,color:#fff

    %% Battlecruiser type
    style AK fill:#FF1493,stroke:#333,stroke-width:2px,color:#fff
```
